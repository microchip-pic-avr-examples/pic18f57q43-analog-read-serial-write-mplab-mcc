/**
  ...
  @Summary
    This is the generated header file for the UART3 driver using CCL
...
#define UART3_isDataReady  (UART3_IsRxReady())
extern const struct UART_INTERFACE UART3_Interface;
...
uart3_status_t __attribute__(( deprecated )) UART3_get_last_status(void);
...
/**
  ...
  @Preconditions
	...
	UART3_isDataReady is a macro which checks if any byte is received.
  ...
  @Example
	<code>
            void main(void) {
                            ...
                            }while(!UART3_isDataReady);		//check if any data is received
...
/**
  ...
  @Description
    ...
    machine.This interrupt service routine is called when the state of the
    UART3 needs to be maintained in a non polled manner.
...
/**
  ...
  @Description
    ...
    machine when device is in sleep and UART3 operation is ceased. 
...
/**
  ...
  @Returns
    None
*/
void (*UART3_FramingErrorInterruptHandler)(void);
...
/**
  ...
  @Returns
    None
*/
void (*UART3_UARTInterruptHandler)(void);
